...
| File | Path | Purpose |
|------|------|---------|
| **Python AI Script** | `./main.py` | YOLOv8s person detection engine with threading, ONNX, Firebase push |
| **ONNX Model** | `./yolov8s.onnx` | Auto-exported optimized AI model (42.8MB) |
| **PyTorch Model** | `./yolov8s.pt` | Original YOLOv8s weights (22MB) |
| **SENTINEL Dashboard** | `../BOT_WEBSITE_FINAL_1.html` | 1400+ line single-file web dashboard with Firebase integration |
| **ESP32 Firmware** | `../BOT_CAM_1/` | Arduino project for ESP32-CAM (CameraWebServer) |
| **Simple Dashboard** | `./dashboard/` | Earlier minimal Firebase dashboard (index.html, app.js, styles.css, firebase-config.js) |
...
| Radar Sensor | HI-LINK HLK-LD2410C-P | 24GHz mmWave motion detection | Not yet integrated |
